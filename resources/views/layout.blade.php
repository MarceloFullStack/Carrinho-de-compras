    ...
    <header>
        <nav>
            <div class="nav-wrapper grey darken-4 row">
                <a href="{{ route('index') }}" class="brand-logo col offset-l1">Minha LOJINHA</a>
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    @else
                        <li>
                            <a class="dropdown-button" data-beloworigin='true' href="#!" data-activates="dropdown-user">
    ...
    <footer class="page-footer grey darken-4">
        <div class="footer-copyright">
            <div class="container center">
                Teste de resolução de problemas nível iniciante
            </div>
        </div>
    </footer>
